...
for n=1:6,
    F_abs(n)=str2num(absorption_table{15,n+1});
end;
for k=1:limit-15, % The table starts at Excel row 15
    surface_list{k}=absorption_table{k+15,1};
    for n=1:6
        surface_data(k,n)=str2num(absorption_table{k+15,n+1});
    end;
end;
