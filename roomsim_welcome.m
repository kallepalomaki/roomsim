...
%Usage: roomsim_welcome;   This presents the welcome notice and responds to
% acceptance of the copyright conditions.
%
...
%------ Welcome Screen -----------------
welcome=strvcat(...
    '   Copyright (C) February 2003 Douglas R. Campbell & Kalle Palomaki'...
    ,' '...
    ,'       This BETA version 1.1 of Roomsim will expire on 1 July 2003.'...
    ,' '...
    ...
    ,'The HRTF data from both CIPIC and MIT Media Lab is their copyright.'...
    ,'Both organisations have agreed to allow this redistribution of'...
    ,'their data. Anyone wishing to redistribute the CIPIC or MIT Media Lab data'...
    ,'other than in this program should first obtain their permission.'...
    ,' '...
    ,'The MATLAB version 6.5 release 13 source m-code should be available'...
    ,'by Q4 2003, and also an executable version not needing MATLAB.'...
    ,'It will be free for use in teaching and non-commercial academic research.'...
...
CANCELstring='Quit';
[dummy,OK]=listdlg('PromptString',PROMPTstring,'SelectionMode','single','ListSize',[500 500]...
