function [data] = high_pass_filter(fig_loc);
% High-Pass 4th order Butterworth filter Cut-off 0.0023*Nyquist frequency, used for LF ripple & DC removal
%i.e. Fs=44.1 kHz Fc= 50 Hz, Fs=10 kHz Fc= 11 Hz
%-------------------------------------------------------
...
% High-pass filter
load HP_coeffs; % Numerator & Denominator coefficients generated using [B,A]= butter(4,50/22050,'high')
